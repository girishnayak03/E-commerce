...
echo [10/11] Starting Payment Service (Port 8087)...
start "Payment Service" /D "%~dp0payment-service" cmd /k "mvn clean spring-boot:run"

echo [11/11] Starting Frontend (Port 5173)...
